...
- **portfolio-dark** (port 21524, `/dark`) — Dark-themed companion built from `Portfolio-Kristina-Ermilova-Dark_1778054769267.pptx`. Uses pure React grid layout (no PNG overlay) since the dark PPTX content extends beyond the slide canvas. 8 cards on slide 2 (3 with decorative ▶ VIDEO badge — no real videos), 4 cards on slide 3. Theme: #0E0D0C bg, #F0EDE8 fg, #6A6460 muted, #E03018 accent. Same 3-section flow + lightbox + nav pill as light version. All photos, no MP4s. Shares fonts with light.
